...
async fn test_compress_payload_gzip() {
    let data = Bytes::from(
        "Hello, world! This is test data for compression. It needs to be long enough to actually compress effectively with gzip. Let's add more text to make sure compression works properly.",
    );
...
async fn test_compress_payload_zstd() {
    let data = Bytes::from(
        "Hello, world! This is test data for compression with Zstd. It needs to be long enough to actually compress effectively with zstd. Let's add more text to make sure compression works properly.",
    );
